define(["app", "views/loginView", "views/homeView", "views/headerView", "views/FooterView",
    "views/navigationView", "models/SessionModel", 'jquery-cookie'],
        function(app, loginview, homeview, headerview, navigationview, footerView, 
                sessionmodel) {
            ...
            var AppRouter = Backbone.Router.extend({
                ...
                home: function() {
                    ...
                    app.headerView.render(app.sessionModel.get("userName"));
                     ...
                     app.navigationView = app.navigationView || new navigationview();
                     app.navigationView.render();
                  
                    app.footerView = app.footerView || new footerView();
                    app.footerView.render();
                    
                    app.homeView = app.homeView || new homeview();
                    app.homeView.render();
                },
